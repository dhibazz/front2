...
const LatestTranaction = () => {
  ...
  return (
    <React.Fragment>
      <Card>
        <CardBody>
          <CardTitle className="mb-4">Offres</CardTitle>
            ...
            <table className="table align-middle table-nowrap mb-0">
              <thead className="table-light">
                <tr>
                  ...
                  <th className="align-middle">Poste</th>
                  <th className="align-middle">Descrption</th>
                  <th className="align-middle">Emplacement</th>
                  <th className="align-middle">Experience</th>
                  <th className="align-middle">Type de contrat</th>
                  <th className="align-middle">Niveau d'etude</th>
                </tr>
              </thead>
              <tbody>
